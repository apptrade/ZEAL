...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ZEAL", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "2016 ZEAL is leading the way for a new crypto";
        CTransaction txNew;
        txNew.nTime = 1457553070;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1457553070;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 903397;


        assert(block.hashMerkleRoot == uint256("0x865e44e1aad7bbc8448dfc5f0ad394921645affbd7aa5d13435857b2b5147e33"));
